...
use App\Http\Resources\ParkigResource;
    ...
    public function start(Request $request)
    {
        ...
        if (Parking::active()->where('vehicle_id', $request->vehicle_id)->exists()) {
            return response()->json([
                'errors' => ['general' => ['Can\'t start parking twice same vehicle, Please stop currently active parking.']]
        ...
        return ParkigResource::make($parking);
    }
